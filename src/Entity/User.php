...
#[ApiResource(
    ...
    operations: [
        ...
        new Get(security: 'is_granted("PERMISSION_USERS_MANAGE")', requirements: ['username' => '[^/]+']),
        new Post(security: 'is_granted("PERMISSION_USERS_MANAGE")', processor: UserPasswordProcessor::class),
        new Put(security: 'is_granted("PERMISSION_USERS_MANAGE")', requirements: ['username' => '[^/]+'], processor: UserPasswordProcessor::class),
        new Patch(security: 'is_granted("PERMISSION_USERS_MANAGE")', requirements: ['username' => '[^/]+']),
        new Delete(security: 'is_granted("PERMISSION_USERS_MANAGE")', requirements: ['username' => '[^/]+']),
    ],
